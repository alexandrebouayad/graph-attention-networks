...
#     def __init__(self, in_features, hid_units, n_classes, n_heads):
#         super().__init__()
#         self.first_layer = GraphAttentionLayer(
#             in_features, hid_units, n_heads[0]
#         )
#         self.second_layer = GraphAttentionLayer(
#             hid_units * n_heads[0], n_classes, n_heads[1], final=True
#         )
